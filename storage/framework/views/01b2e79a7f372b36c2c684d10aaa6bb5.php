...
<body class="bg-gray-100 flex h-screen overflow-hidden">
            ...
            <div class="p-6">
                <div class="max-w-8xl p-6 bg-white rounded-lg shadow-md">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md mb-6">
                        <form action="<?php echo e(route('penyewa.cari-motor')); ?>" method="GET" class="flex flex-wrap md:flex-nowrap items-center gap-4">
                            <div class="flex-1 w-full md:w-auto">
                                <label for="brand_search" class="block text-sm font-medium text-gray-700">Cari Merk</label>
                                <input type="text" id="brand_search" name="brand" placeholder="e.g., Honda, Yamaha" class="mt-1 block w-full rounded-md" value="<?php echo e(request('brand')); ?>">
                            </div>
                            ...
                            <div class="flex-1 w-full md:w-auto">
                                ...
                                <select id="type_cc" name="type_cc" class="mt-1 block w-full rounded-md">
                                    <option value="" <?php echo e(request('type_cc') == '' ? 'selected' : ''); ?>>Semua</option>
                                    <option value="100" <?php echo e(request('type_cc') == '100' ? 'selected' : ''); ?>>100cc</option>
                                    <option value="125" <?php echo e(request('type_cc') == '125' ? 'selected' : ''); ?>>125cc</option>
                                    <option value="150" <?php echo e(request('type_cc') == '150' ? 'selected' : ''); ?>>150cc</option>
                                </select>
                            </div>
                            ...
                            <div class="flex-1 w-full md:w-auto">
                                ...
                                <select id="price_range" name="price_range" class="mt-1 block w-full rounded-md">
                                    <option value="" <?php echo e(request('price_range') == '' ? 'selected' : ''); ?>>Semua Harga</option>
                                    <option value="<100000" <?php echo e(request('price_range') == '<100000' ? 'selected' : ''); ?>>
                                        < Rp 100.000 </option>
                                    <option value="100000-150000" <?php echo e(request('price_range') == '100000-150000' ? 'selected' : ''); ?>> Rp 100.000 - Rp 150.000 </option>
                                    <option value=">150000" <?php echo e(request('price_range') == '>150000' ? 'selected' : ''); ?>> > Rp 150.000 </option>
                                </select>
                            </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300">
                            <img class="w-full h-48 object-cover" src="<?php echo e(asset($motor->photo_url)); ?>" alt="<?php echo e($motor->brand); ?>">
                            <div class="p-4">
                                <h4 class="text-xl font-bold text-gray-900"><?php echo e($motor->brand); ?></h4>
                                <p class="text-gray-500 mt-1">Tipe : <?php echo e($motor->type_cc); ?>cc</p>
                                <p class="text-gray-500">Plat : <?php echo e($motor->plate_number); ?></p>
                                <p class="text-gray-500 text-sm mt-1">
                                    <?php if($motor->bookings_count > 0): ?>
                                    Sudah disewa <?php echo e($motor->bookings_count); ?> kali
                                    <?php else: ?>
                                    Belum pernah disewa
                                    <?php endif; ?>
                                </p>
                                ...
                                <button type="button"
                                    ...
                                    data-motor-id="<?php echo e($motor->id); ?>"
                                    data-motor-brand="<?php echo e($motor->brand); ?>"
                                    data-motor-type="<?php echo e($motor->type_cc); ?>"
                                    data-motor-plate="<?php echo e($motor->plate_number); ?>"
                                    data-motor-photo="<?php echo e(asset($motor->photo_url)); ?>"
                                    data-motor-harian="<?php echo e($motor->rentalRates->harian ?? 0); ?>"
                                    data-motor-mingguan="<?php echo e($motor->rentalRates->mingguan ?? 0); ?>"
                                    data-motor-bulanan="<?php echo e($motor->rentalRates->bulanan ?? 0); ?>"
    ...
    <script>
        ...
        function resetFilter() {
            window.location.href = "<?php echo e(route('penyewa.cari-motor')); ?>";
        }
    </script>
</body>

</html><?php /**PATH D:\PROJEK PROJEK\rental-motor\rental-motor\resources\views/penyewa/cari-motor.blade.php ENDPATH**/ ?>