            ...
            <div class="p-6">
                <div class="max-w-7xl mx-auto my-5 p-6 bg-white rounded-lg shadow-md">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="<?php echo e(route('admin.laporan.download', 'word')); ?>"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div class="bg-gray-200 text-gray-800 p-6 rounded-lg shadow-sm flex items-center justify-between">
                            <div>
                                ...
                                <div class="text-xl font-bold mt-1">Rp <?php echo e(number_format($totalGrossRevenue, 0, ',', '.')); ?></div>
                            </div>
                        ...
                        <div class="bg-indigo-100 text-indigo-800 p-6 rounded-lg shadow-sm flex items-center justify-between">
                            <div>
                                ...
                                <div class="text-xl font-bold mt-1">Rp <?php echo e(number_format($rmcRevenue, 0, ',', '.')); ?></div>
                            </div>
                        ...
                        <div class="bg-teal-100 text-teal-800 p-6 rounded-lg shadow-sm flex items-center justify-between">
                            <div>
                                ...
                                <div class="text-xl font-bold mt-1">Rp <?php echo e(number_format($ownerShare, 0, ',', '.')); ?></div>
                            </div>
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg shadow-sm overflow-x-auto">
                        ...
                        <?php if($completedBookings->isEmpty()): ?>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                        <?php echo e($booking->renter->name); ?>
                        ...
                        <?php if($booking->status == 'disetujui'): ?> bg-green-100 text-green-800
                        <?php elseif($booking->status == 'selesai'): ?> bg-blue-100 text-blue-800
                        <?php elseif($booking->status == 'pending'): ?> bg-yellow-100 text-yellow-800
                        <?php elseif($booking->status == 'dibatalkan'): ?> bg-red-100 text-red-800
                        <?php else: ?> bg-gray-100 text-gray-800 <?php endif; ?>">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">
                                        ...
                                        Rp <?php echo e(number_format($booking->revenueSharing->pemilik_share + $booking->revenueSharing->admin_share, 0, ',', '.')); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-green-600">
                                        <!-- Pendapatan RMC dari revenue_sharings -->
                                        Rp <?php echo e(number_format($booking->revenueSharing->admin_share, 0, ',', '.')); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-blue-600">
                                        <!-- Bagi hasil pemilik dari revenue_sharings -->
                                        Rp <?php echo e(number_format($booking->revenueSharing->pemilik_share, 0, ',', '.')); ?>
                            ...
                            <tfoot class="bg-gray-50 font-semibold">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-green-600">
                                        Rp <?php echo e(number_format($rmcRevenue, 0, ',', '.')); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-blue-600">
                                        Rp <?php echo e(number_format($ownerShare, 0, ',', '.')); ?>
                    ...
                    <div class="overflow-x-auto mt-10">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__empty_1 = true; $__currentLoopData = $popularMotors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $motor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="transition-colors duration-150 hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <?php else: ?>
                                            <span class="bg-gray-100 text-gray-600 text-xs font-semibold px-2.5 py-0.5 rounded-full">#<?php echo e($index + 1); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <img class="h-10 w-10 rounded-full mr-4 object-cover" src="<?php echo e(asset($motor->photo_url)); ?>" alt="<?php echo e($motor->brand); ?>">
                                            <?php else: ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                                <?php if($motor->status == 'tersedia'): ?> bg-green-100 text-green-800
                                                <?php elseif($motor->status == 'disewa'): ?> bg-red-100 text-red-800
                                                <?php elseif($motor->status == 'maintenance'): ?> bg-yellow-100 text-yellow-800
                                                <?php else: ?> bg-gray-100 text-gray-800 <?php endif; ?>">
                                            <?php echo e(ucfirst($motor->status)); ?>

                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-bold text-gray-800"><?php echo e($motor->rentals_count); ?></div>
                                        <div class="text-xs text-gray-500">kali disewa</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-green-600">
                                        <!-- Asumsikan ada field total_revenue di model Motor -->
                                        Rp <?php echo e(number_format($motor->total_revenue ?? 0, 0, ',', '.')); ?>
...
</html><?php /**PATH D:\PROJEK PROJEK\rental-motor\rental-motor\resources\views/admin/laporan.blade.php ENDPATH**/ ?>