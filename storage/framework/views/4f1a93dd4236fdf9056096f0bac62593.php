        ...
        <main class="flex-1">
            <div class="p-6">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="text-sm text-gray-500">
                                            <?php echo e($booking->renter->email); ?>
                                    ...
                                    <!-- <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <form action="<?php echo e(route('admin.pemesanan.approve', $booking)); ?>" method="POST" class="inline-block">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit" class="text-green-600 hover:text-green-900 mr-2">Setujui</button>
                                        </form>
                                        <form action="<?php echo e(route('admin.pemesanan.reject', $booking)); ?>" method="POST" class="inline-block">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <button type="button"
                                            ...
                                            data-total-biaya="<?php echo e($booking->total_biaya); ?>">
                                            Setujui
                                        </button>
                                        <form action="<?php echo e(route('admin.pemesanan.reject', $booking)); ?>" method="POST" class="inline-block">
                                            <?php echo csrf_field(); ?>
                ...
                <div class="mt-8 p-8 bg-white rounded-lg shadow-md">
                    ...
                    <?php if($allBookingsAdmin->isEmpty()): ?>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200" id="admin-bookings-table">
                                <?php $__currentLoopData = $allBookingsAdmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="admin-booking-row" data-status="<?php echo e($booking->status); ?>">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <?php if($booking->motor && $booking->motor->photo_url): ?>
                                                <img class="h-10 w-10 rounded-full object-cover" src="<?php echo e(asset($booking->motor->photo_url)); ?>" alt="<?php echo e($booking->motor->brand); ?>">
                                                <?php else: ?>
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900">
                                                    <?php echo e($booking->motor->brand ?? 'N/A'); ?> <?php echo e($booking->motor->type_cc ?? ''); ?>cc
                                                </div>
                                                <div class="text-sm text-gray-500">
                                                    <?php echo e($booking->motor->plate_number ?? 'N/A'); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">
                                            <?php echo e($booking->renter->name ?? 'N/A'); ?>

                                        </div>
                                        <div class="text-sm text-gray-500">
                                            <?php echo e($booking->renter->email ?? 'N/A'); ?>

                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <?php echo e(\Carbon\Carbon::parse($booking->tanggal_mulai)->format('d M Y')); ?> -
                                        <?php echo e(\Carbon\Carbon::parse($booking->tanggal_selesai)->format('d M Y')); ?>
                    ...
                    <!-- Pagination -->
                    <?php if($allBookingsAdmin->hasPages()): ?>
                    <div class="mt-4">
                        <?php echo e($allBookingsAdmin->links()); ?>
...
</html><?php /**PATH D:\PROJEK PROJEK\rental-motor\rental-motor\resources\views/admin/manajemen-pemesanan.blade.php ENDPATH**/ ?>