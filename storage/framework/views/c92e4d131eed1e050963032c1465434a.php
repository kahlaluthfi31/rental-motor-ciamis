                    ...
                    <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                ...
                                <p class="text-2xl font-bold text-green-600"><?php echo e($availableCount); ?></p>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                ...
                                <p class="text-2xl font-bold text-blue-600"><?php echo e($rentedCount); ?></p>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="transition-colors duration-150 hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <img class="h-10 w-10 rounded-full object-cover" src="<?php echo e(asset($motor->photo_url)); ?>" alt="">
                                            </div>
                                            <div class="ml-4">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        Rp <?php echo e(number_format($motor->rentalRates->harian, 0, ',', '.')); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        Rp <?php echo e(number_format($motor->rentalRates->mingguan, 0, ',', '.')); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        Rp <?php echo e(number_format($motor->rentalRates->bulanan, 0, ',', '.')); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="flex flex-col items-start space-y-1">
                                            ...
                                            <span class="text-xs text-gray-500">
                                                Selesai: <?php echo e(\Carbon\Carbon::parse($activeBooking->end_date)->format('d M Y')); ?>
                                        ...
                                        <?php elseif($motor->status == 'dibatalkan'): ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <?php if($motor->status == 'disewa'): ?>
                                        <form action="<?php echo e(route('admin.motor.set-available', $motor->id)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\PROJEK PROJEK\rental-motor\rental-motor\resources\views/admin/manajemen-harga.blade.php ENDPATH**/ ?>