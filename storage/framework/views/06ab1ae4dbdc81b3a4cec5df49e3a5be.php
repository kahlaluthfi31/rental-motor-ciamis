                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 w-12 h-12 p-1">
                                            <img class="w-full h-full rounded-full object-cover shadow-sm"
                                                src="<?php echo e(asset($data->photo_url)); ?>"
                                                alt="<?php echo e($data->brand); ?> <?php echo e($data->type_cc); ?>">
                                        </div>
                                        <div>
                                            <div class="text-sm font-medium text-gray-900"><?php echo e($data->brand); ?> <?php echo e($data->type_cc); ?>cc</div>
                                            <div class="text-xs text-gray-500"><?php echo e($data->plate_number); ?></div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">
                                    ...
                                    Rp <?php echo e(number_format($data->pemilik_share + $data->admin_share, 0, ',', '.')); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-green-600">
                                    <!-- Pendapatan pemilik dari revenue_sharings -->
                                    Rp <?php echo e(number_format($data->pemilik_share, 0, ',', '.')); ?>
...
</html><?php /**PATH D:\PROJEK PROJEK\rental-motor\rental-motor\resources\views/pemilik/laporan.blade.php ENDPATH**/ ?>