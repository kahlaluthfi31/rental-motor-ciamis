        ...
        <main class="flex-1">
            <div class="p-6">
                <div class="max-w-8xl p-6 bg-white rounded-lg shadow-md">
                    <h2 class="text-xl font-bold text-purple-800 mb-6">Riwayat Sewa</h2>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        Rp {{ number_format($booking->total_biaya, 0, ',', '.') }} <br> <span class="text-xs">({{ ucfirst($booking->payment->metode) }})</span>
                                    </td>
                                    <!-- PERBAIKAN: Tampilkan semua status -->
                                    <td class="px-6 py-4 whitespace-nowrap">
