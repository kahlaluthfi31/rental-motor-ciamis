                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-200">
                    <div class="p-6">
                        ...
                        <div class="pt-6 bg-gradient-to-r from-blue-600 to-indigo-700 text-purple-800 rounded-lg flex flex-col md:flex-row items-center justify-between">
                            ...
                            <a href="{{ route('register', ['role' => 'pemilik']) }}" title="Login sebagai pemilik" class="mt-6 md:mt-0 bg-white text-purple-800 font-bold py-3 px-8 rounded-full shadow-lg hover:bg-gray-100 transition-colors duration-200 transform hover:scale-105">
                                Menjadi Pemilik
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-blue-500 transform transition-transform duration-300 hover:scale-[1.02]">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-xl font-extrabold text-gray-900 mt-2">{{ $motorTersedia }}</p>
                            </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-green-500 transform transition-transform duration-300 hover:scale-[1.02]">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-xl font-extrabold text-gray-900 mt-2">{{ $penyewaanAktif }}</p>
                            </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-indigo-500 transform transition-transform duration-300 hover:scale-[1.02]">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-xl font-extrabold text-gray-900 mt-2">{{ $totalPenyewaan }}</p>
                            </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="transition-colors duration-150 hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        ...
                                        <a href="{{ route('penyewa.cari-motor') }}" class="text-blue-600 hover:text-blue-800 font-semibold transition-colors duration-200">
                                            Sewa
                                        </a>
                                        @else
